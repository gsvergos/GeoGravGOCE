===================================================================================================
					GeoGravGOCE 
===================================================================================================
GeoGravGOCE app is a MATLAB®-based Graphical User Interface for:
(1) Pre-processing of the GOCE Satellite Gravity Gradients (GGs).
(2) Transformation of a Global Geopotential Model's GGs from LNOF to GRF.
