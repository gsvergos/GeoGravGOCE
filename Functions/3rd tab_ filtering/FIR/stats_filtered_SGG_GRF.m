function [ stats_filtered_Vij_GRF ] = stats_filtered_SGG_GRF( Vij_filtered,currentFolder)
%    GeoGravGOCE project
%    E. Mamagiannou
...
%    *** input ***
%    Vij_filtered = the FIR filterd Vij = {6x1 cells}
...
%    *** output ***
%    As return, in the "FIR\Statistics_filtered_Vij_GRF" folder, are saved:
%    stats_filtered_Vij_GRF.mat
%    stats_filtered_Vij_GRF_Report.txt
%    ---------------------------------------------------------------------------------------------

%% classification/ Gravity Gradients after filtering, unit: Eötvös
...
% create a folder to save all the figures (.jpeg) "Statistics_Vij_GRF"
p = 1;
foldername = sprintf('Statistics_filtered_Vij_GRF%02',p);
currentFolder1=[currentFolder, '\FIR'];
mkdir(currentFolder1, foldername);
currentFolder2=[currentFolder, '\FIR\Statistics_filtered_Vij_GRF\stats_filtered_Vij_GRF.mat'];
currentFolder3=[currentFolder, '\FIR\Statistics_filtered_Vij_GRF\stats_filtered_Vij_GRF_Report.txt'];
...
% the corresponding report (.txt)/ (info for the user)
%fprintf(2, '\nGeoGravGOCE Info:\n')
Vij_filtered_report=' ';
